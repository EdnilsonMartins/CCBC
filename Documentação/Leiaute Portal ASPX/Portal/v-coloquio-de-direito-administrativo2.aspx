<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="v-coloquio-de-direito-administrativo2.aspx.cs" Inherits="v_coloquio_de_direito_administrativo2" %>
    ...
    <div class="geral-1050">
        <div class="conteudo">
            <div class="internas-navegacao">
                ...
                <a href="#">-</a>
                <a href="v-coloquio-de-direito-administrativo2.aspx">V Colóquio de Direito Administrativo2</a>
            </div>
            <!--lateral esquerda-->
            <div class="lateral">
            ...
            <div class="internas-conteudo">
                <h1>V Colóquio de Direito Administrativo2 </h1>
